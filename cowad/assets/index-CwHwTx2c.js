(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function t(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(s){if(s.ep)return;s.ep=!0;const r=t(s);fetch(s.href,r)}})();class fn{constructor(e,t){this.key=e,this._val=t}val(){return this._val}numChildren(){return this._val&&typeof this._val=="object"?Object.keys(this._val).length:0}}const Pd="cowad-local",fr="data",Xu="store",ki={};let fo=null;function Ld(){return new Promise((i,e)=>{const t=indexedDB.open(Pd,1);t.onupgradeneeded=()=>{t.result.createObjectStore(fr)},t.onsuccess=()=>i(t.result),t.onerror=()=>e(t.error)})}function Id(){return Ld().then(i=>(fo=i,new Promise(e=>{const n=i.transaction(fr,"readonly").objectStore(fr).get(Xu);n.onsuccess=()=>{n.result&&Object.assign(ki,n.result),e()},n.onerror=()=>e()}))).catch(()=>{})}let Go=null;function Sl(){fo&&(Go||(Go=setTimeout(()=>{if(Go=null,!fo)return;fo.transaction(fr,"readwrite").objectStore(fr).put(structuredClone(ki),Xu)},100)))}const ir=new Map;function li(i,e){const t=ir.get(i);return t?t.filter(n=>n.event===e).map(n=>n.callback):[]}function Dd(i,e,t){ir.has(i)||ir.set(i,[]),ir.get(i).push({event:e,callback:t})}function Jn(i){let e=ki;for(const t of i){if(e==null||typeof e!="object")return;e=e[t]}return e}function Wo(i,e){if(i.length===0){if(e==null)for(const s of Object.keys(ki))delete ki[s];else typeof e=="object"&&Object.assign(ki,e);return}let t=ki;for(let s=0;s<i.length-1;s++)(t[i[s]]==null||typeof t[i[s]]!="object")&&(t[i[s]]={}),t=t[i[s]];const n=i[i.length-1];e==null?delete t[n]:t[n]=e}function Xo(i,e,t,n){if(e.length>=2){const o=e.slice(0,-1).join("/"),a=e[e.length-1],c=t!==void 0,l=n==null;if(!c&&!l)for(const u of li(o,"child_added"))u(new fn(a,n));else if(c&&l)for(const u of li(o,"child_removed"))u(new fn(a,t));else if(c&&!l)for(const u of li(o,"child_changed"))u(new fn(a,n))}for(const o of li(i,"value"))o(new fn(e[e.length-1]||"",n??null));if(e.length>=2){const o=e.slice(0,-1).join("/"),a=Jn(e.slice(0,-1));for(const c of li(o,"value"))c(new fn(e[e.length-2]||"",a??null))}if(n==null&&t&&typeof t=="object")for(const[o,a]of ir){if(!o.startsWith(i+"/"))continue;const c=o.slice(i.length+1).split("/");let l=t;for(const f of c){if(l==null||typeof l!="object"){l=void 0;break}l=l[f]}if(l==null||typeof l!="object")continue;const u=a.filter(f=>f.event==="child_removed").map(f=>f.callback);for(const f of u)for(const[d,h]of Object.entries(l))f(new fn(d,h))}const s=t!=null&&typeof t=="object";if(n!=null&&typeof n=="object"){const o=s?new Set(Object.keys(t)):new Set;for(const[a,c]of Object.entries(n))if(o.has(a)){if(JSON.stringify(t[a])!==JSON.stringify(c))for(const l of li(i,"child_changed"))l(new fn(a,c))}else for(const l of li(i,"child_added"))l(new fn(a,c));if(s){for(const a of Object.keys(t))if(!(a in n))for(const c of li(i,"child_removed"))c(new fn(a,t[a]))}}}let Ud=Date.now();class zc{constructor(e){this._path=e.replace(/^\/+|\/+$/g,"")}get key(){const e=this._path.split("/");return e[e.length-1]||""}get segments(){return this._path?this._path.split("/"):[]}child(e){const t=this._path?`${this._path}/${e}`:e;return new zc(t)}set(e){const t=this.segments,n=Jn(t);Wo(t,e);const s=Jn(t);return Xo(this._path,t,n,s),Sl(),Promise.resolve()}update(e){if(e==null)return Promise.resolve();const t=this.segments;if(t.length===0)for(const[n,s]of Object.entries(e)){const r=n.split("/").filter(c=>c),o=Jn(r);Wo(r,s);const a=Jn(r);Xo(n,r,o,a)}else{const n=Jn(t),s=n&&typeof n=="object"?{...n}:{};for(const[r,o]of Object.entries(e))o==null?delete s[r]:s[r]=o;Wo(t,s),Xo(this._path,t,n,s)}return Sl(),Promise.resolve()}remove(){return this.set(null)}push(e){const t="-"+(++Ud).toString(36)+Math.random().toString(36).slice(2,8),n=this.child(t);if(e!==void 0){const r=n.set(e).then(()=>n);return r.key=t,r}const s=Promise.resolve(n);return s.key=t,s}on(e,t){if(Dd(this._path,e,t),e==="value"){const n=Jn(this.segments);t(new fn(this.key,n??null))}else if(e==="child_added"){const n=Jn(this.segments);if(n&&typeof n=="object")for(const[s,r]of Object.entries(n))t(new fn(s,r))}}once(e){const t=Jn(this.segments);return Promise.resolve(new fn(this.key,t??null))}onDisconnect(){return{remove(){}}}}class Nd{ref(e){return new zc(e||"")}}function Fd(){const i=Id();return{db:new Nd,ready:i}}const Vc="cowad-firebase-config",Hc="cowad-firebase-connected";function Od(){return localStorage.getItem(Vc)!==null}function $u(){try{const i=localStorage.getItem(Vc);return i?JSON.parse(i):null}catch{return null}}function Bd(i){localStorage.setItem(Vc,JSON.stringify(i))}let qu=!1,It,Da;const kd=localStorage.getItem(Hc)==="true",yl=$u();if(kd&&yl)firebase.initializeApp({...yl}),It=firebase.database(),qu=!0,Da=Promise.resolve();else{const i=Fd();It=i.db,Da=i.ready}function pe(i){return It.ref("map/"+i)}function Yu(){localStorage.setItem(Hc,"true"),location.reload()}function zd(){localStorage.setItem(Hc,"false"),location.reload()}const Vd=Math.random().toString(36).slice(2,10),P={vertices:new Map,linedefs:new Map,sidedefs:new Map,sectors:new Map,things:new Map};let Qt="select",be=null,kt={x:0,y:0},ft=1,Ku=!1,Ks={mx:0,my:0,px:0,py:0},ju=!1,Nn=null,rt={x:0,y:0},Rt=null,Ct=[],et=new Set,Pt=null,Gi=null,xn=8,$i=null,dr=new Map,Tr="doom2";function Hd(i){Qt=i}function Vt(i){be=i}function Zu(i){ft=i}function To(i){Ku=i}function Ju(i){Ks=i}function Ml(i){ju=i}function $o(i){Nn=i}function Gd(i){rt=i}function Qu(i){Rt=i}function Wd(i){Ct=i}function Bt(i,e){et=i,e!==void 0&&(Pt=e),i.size===0&&(Pt=null,dr=new Map),Pt!=="linedef"&&(dr=new Map)}function Xd(i){dr=i}function Ao(i){Gi=i}function $d(i){xn=i}function hr(i){$i=i}function ef(i){Tr=i}let tf=()=>{},nf=()=>{},sf=()=>{};function qd(i){tf=i.draw,nf=i.renderPanel,i.rebuild3D&&(sf=i.rebuild3D)}function Wi(){tf(),sf()}function Mi(){nf()}const Ar={1:{name:"Player 1 Start",cat:"player",radius:16},2:{name:"Player 2 Start",cat:"player",radius:16},3:{name:"Player 3 Start",cat:"player",radius:16},4:{name:"Player 4 Start",cat:"player",radius:16},11:{name:"Deathmatch Start",cat:"player",radius:16},3004:{name:"Zombieman",cat:"enemy",radius:20},9:{name:"Shotgun Guy",cat:"enemy",radius:20},3001:{name:"Imp",cat:"enemy",radius:20},3002:{name:"Demon",cat:"enemy",radius:30},58:{name:"Spectre",cat:"enemy",radius:30},3005:{name:"Cacodemon",cat:"enemy",radius:31},3003:{name:"Baron of Hell",cat:"enemy",radius:24},3006:{name:"Lost Soul",cat:"enemy",radius:16},16:{name:"Cyberdemon",cat:"enemy",radius:40},7:{name:"Spider Mastermind",cat:"enemy",radius:128},65:{name:"Chaingun Guy",cat:"enemy",radius:20,doom2Only:!0},64:{name:"Arch-Vile",cat:"enemy",radius:20,doom2Only:!0},66:{name:"Revenant",cat:"enemy",radius:20,doom2Only:!0},67:{name:"Mancubus",cat:"enemy",radius:48,doom2Only:!0},68:{name:"Arachnotron",cat:"enemy",radius:64,doom2Only:!0},69:{name:"Hell Knight",cat:"enemy",radius:24,doom2Only:!0},71:{name:"Pain Elemental",cat:"enemy",radius:31,doom2Only:!0},84:{name:"Wolfenstein SS",cat:"enemy",radius:20,doom2Only:!0},2005:{name:"Chainsaw",cat:"weapon",radius:10},2001:{name:"Shotgun",cat:"weapon",radius:10},82:{name:"Super Shotgun",cat:"weapon",radius:10,doom2Only:!0},2002:{name:"Chaingun",cat:"weapon",radius:10},2003:{name:"Rocket Launcher",cat:"weapon",radius:10},2004:{name:"Plasma Rifle",cat:"weapon",radius:10},2006:{name:"BFG 9000",cat:"weapon",radius:10},2007:{name:"Clip",cat:"ammo",radius:10},2048:{name:"Box of Bullets",cat:"ammo",radius:10},2008:{name:"Shells",cat:"ammo",radius:10},2049:{name:"Box of Shells",cat:"ammo",radius:10},2010:{name:"Rocket",cat:"ammo",radius:10},2046:{name:"Box of Rockets",cat:"ammo",radius:10},2047:{name:"Energy Cell",cat:"ammo",radius:10},17:{name:"Energy Cell Pack",cat:"ammo",radius:10},2014:{name:"Health Bonus",cat:"health",radius:10},2011:{name:"Stimpack",cat:"health",radius:10},2012:{name:"Medikit",cat:"health",radius:10},2013:{name:"Soulsphere",cat:"health",radius:10},83:{name:"Megasphere",cat:"health",radius:10,doom2Only:!0},2015:{name:"Armor Bonus",cat:"armor",radius:10},2018:{name:"Green Armor",cat:"armor",radius:10},2019:{name:"Blue Armor",cat:"armor",radius:10},5:{name:"Blue Keycard",cat:"key",radius:10},13:{name:"Red Keycard",cat:"key",radius:10},6:{name:"Yellow Keycard",cat:"key",radius:10},40:{name:"Blue Skull Key",cat:"key",radius:10},38:{name:"Red Skull Key",cat:"key",radius:10},39:{name:"Yellow Skull Key",cat:"key",radius:10},2022:{name:"Invulnerability",cat:"powerup",radius:10},2023:{name:"Berserk",cat:"powerup",radius:10},2024:{name:"Invisibility",cat:"powerup",radius:10},2025:{name:"Radiation Suit",cat:"powerup",radius:10},2026:{name:"Computer Map",cat:"powerup",radius:10},2045:{name:"Light Goggles",cat:"powerup",radius:10},2035:{name:"Barrel",cat:"decor",radius:10},70:{name:"Burning Barrel",cat:"decor",radius:10,doom2Only:!0},43:{name:"Burnt Tree",cat:"decor",radius:16},54:{name:"Brown Tree",cat:"decor",radius:16},2028:{name:"Floor Lamp",cat:"decor",radius:16},85:{name:"Tall Techno Lamp",cat:"decor",radius:16},86:{name:"Short Techno Lamp",cat:"decor",radius:16},34:{name:"Candle",cat:"decor",radius:16},35:{name:"Candelabra",cat:"decor",radius:16},44:{name:"Tall Blue Torch",cat:"decor",radius:16},45:{name:"Tall Green Torch",cat:"decor",radius:16},46:{name:"Tall Red Torch",cat:"decor",radius:16},55:{name:"Short Blue Torch",cat:"decor",radius:16},56:{name:"Short Green Torch",cat:"decor",radius:16},57:{name:"Short Red Torch",cat:"decor",radius:16},48:{name:"Tall Techno Column",cat:"decor",radius:16},30:{name:"Tall Green Pillar",cat:"decor",radius:16},32:{name:"Short Green Pillar",cat:"decor",radius:16},31:{name:"Tall Red Pillar",cat:"decor",radius:16},33:{name:"Short Red Pillar",cat:"decor",radius:16},36:{name:"Pillar w/ Heart",cat:"decor",radius:16},37:{name:"Pillar w/ Skull",cat:"decor",radius:16},47:{name:"Brown Stump",cat:"decor",radius:16},41:{name:"Evil Eye",cat:"decor",radius:16},42:{name:"Floating Skull",cat:"decor",radius:16},10:{name:"Bloody Mess 1",cat:"gore",radius:16},12:{name:"Bloody Mess 2",cat:"gore",radius:16},24:{name:"Pool of Blood",cat:"gore",radius:16},27:{name:"Pole w/ Skull",cat:"gore",radius:16},28:{name:"Skewer w/ Heads",cat:"gore",radius:16},29:{name:"Pile of Skulls",cat:"gore",radius:16},25:{name:"Impaled Body",cat:"gore",radius:16},26:{name:"Twitching Body",cat:"gore",radius:16},49:{name:"Hanging Body 1",cat:"gore",radius:16},50:{name:"Hanging Body 2",cat:"gore",radius:16},51:{name:"Hanging Body 3",cat:"gore",radius:16},52:{name:"Hanging Body 4",cat:"gore",radius:16},53:{name:"Hanging Body 5",cat:"gore",radius:16},73:{name:"Hanging Body 6",cat:"gore",radius:16},74:{name:"Hanging Body 7",cat:"gore",radius:16},75:{name:"Hanging Body 8",cat:"gore",radius:16},76:{name:"Hanging Body 9",cat:"gore",radius:16},77:{name:"Hanging Body 10",cat:"gore",radius:16},78:{name:"Hanging Body 11",cat:"gore",radius:16},79:{name:"Hanging Body 12",cat:"gore",radius:16},15:{name:"Dead Marine",cat:"gore",radius:16},18:{name:"Dead Zombieman",cat:"gore",radius:16},19:{name:"Dead Shotgun Guy",cat:"gore",radius:16},20:{name:"Dead Imp",cat:"gore",radius:16},21:{name:"Dead Demon",cat:"gore",radius:16},22:{name:"Dead Cacodemon",cat:"gore",radius:16},23:{name:"Dead Lost Soul",cat:"gore",radius:16},14:{name:"Teleport Landing",cat:"decor",radius:16},88:{name:"Boss Brain",cat:"enemy",radius:16,doom2Only:!0},89:{name:"Spawn Shooter",cat:"enemy",radius:16,doom2Only:!0},87:{name:"Spawn Spot",cat:"enemy",radius:16,doom2Only:!0}},wr={1:"PLAY",2:"PLAY",3:"PLAY",4:"PLAY",11:"PLAY",3004:"POSS",9:"SPOS",3001:"TROO",3002:"SARG",58:"SARG",3005:"HEAD",3003:"BOSS",3006:"SKUL",16:"CYBR",7:"SPID",65:"CPOS",64:"VILE",66:"SKEL",67:"FATT",68:"BSPI",69:"BOS2",71:"PAIN",84:"SSWV",2005:"CSAW",2001:"SHOT",82:"SGN2",2002:"MGUN",2003:"LAUN",2004:"PLAS",2006:"BFUG",2007:"CLIP",2048:"AMMO",2008:"SHEL",2049:"SBOX",2010:"ROCK",2046:"BROK",2047:"CELL",17:"CELP",2014:"BON1",2011:"STIM",2012:"MEDI",2013:"SOUL",83:"MEGA",2015:"BON2",2018:"ARM1",2019:"ARM2",5:"BKEY",13:"RKEY",6:"YKEY",40:"BSKU",38:"RSKU",39:"YSKU",2022:"PINV",2023:"PSTR",2024:"PINS",2025:"SUIT",2026:"PMAP",2045:"PVIS",2035:"BAR1",70:"FCAN",43:"TRE1",54:"TRE2",2028:"COLU",85:"TLMP",86:"TLP2",34:"CAND",35:"CBRA",44:"TBLU",45:"TGRN",46:"TRED",55:"SMBT",56:"SMGT",57:"SMRT",48:"ELEC",30:"COL1",32:"COL3",31:"COL2",33:"COL4",36:"COL5",37:"COL6",47:"SMIT",41:"CEYE",42:"FSKU",10:"POL5",12:"POL5",24:"POL5",27:"POL4",28:"POL2",29:"POL3",25:"POL1",26:"POL6",49:"GOR1",50:"GOR2",51:"GOR3",52:"GOR4",53:"GOR5",73:"HDB1",74:"HDB2",75:"HDB3",76:"HDB4",77:"HDB5",78:"HDB6",79:"POB1",15:"PLAYN",18:"POSSL",19:"SPOSL",20:"TROOM",21:"SARGN",22:"HEADL",23:"SKULK",14:"TFOG",88:"BBRN",89:"BOSF",87:"FIRE"},rf=[{bit:1,label:"Impassable"},{bit:4,label:"Two-Sided"},{bit:16,label:"Upper Unpeg"},{bit:32,label:"Lower Unpeg"}];function _t(i,e){return{x:i*ft+kt.x,y:-e*ft+kt.y}}function Fi(i,e){return{x:(i-kt.x)/ft,y:-(e-kt.y)/ft}}function zt(i,e=xn){return Math.round(i/e)*e}function Yd(i){const e=new DataView(i),t=String.fromCharCode(e.getUint8(0),e.getUint8(1),e.getUint8(2),e.getUint8(3));if(t!=="IWAD"&&t!=="PWAD")throw new Error("Not a WAD file");const n=e.getInt32(4,!0),s=e.getInt32(8,!0),r=[];for(let o=0;o<n;o++){const a=s+o*16,c=e.getInt32(a,!0),l=e.getInt32(a+4,!0);let u="";for(let f=0;f<8;f++){const d=e.getUint8(a+8+f);if(d===0)break;u+=String.fromCharCode(d)}r.push({name:u.toUpperCase(),offset:c,size:l})}return{type:t,lumps:r,data:i}}function Ua(i,e){const t=e.toUpperCase(),n=i.lumps.find(s=>s.name===t);return!n||n.size===0?null:{dv:new DataView(i.data,n.offset,n.size),offset:n.offset,size:n.size}}function pr(i,e,t){const n=e.toUpperCase(),s=t.toUpperCase(),r=[];let o=!1;for(const a of i.lumps){if(a.name===n){o=!0;continue}if(a.name===s){o=!1;continue}o&&a.size>0&&r.push(a)}return r}function Kd(i){const e=Ua(i,"PLAYPAL");if(!e)throw new Error("PLAYPAL lump not found");const t=new Uint8Array(768);for(let n=0;n<768;n++)t[n]=e.dv.getUint8(n);return t}function jd(i,e){const t=[],n=[["F_START","F_END"],["F1_START","F1_END"],["F2_START","F2_END"],["FF_START","FF_END"]],s=new Set;for(const[r,o]of n){const a=pr(i,r,o);for(const c of a){if(c.size!==4096||s.has(c.name))continue;s.add(c.name);const l=new Uint8Array(i.data,c.offset,4096),u=new ImageData(64,64),f=u.data;for(let d=0;d<4096;d++){const h=l[d];f[d*4]=e[h*3],f[d*4+1]=e[h*3+1],f[d*4+2]=e[h*3+2],f[d*4+3]=255}t.push({name:c.name,type:"flat",width:64,height:64,dataUrl:Gc(u)})}}return t}function of(i,e,t){if(t<8)return null;const n=new DataView(i,e,t),s=n.getUint16(0,!0),r=n.getUint16(2,!0),o=n.getInt16(6,!0);if(s===0||r===0||s>4096||r>4096||t<8+s*4)return null;const a=new Uint8Array(s*r);a.fill(255);for(let c=0;c<s;c++){let l=n.getUint32(8+c*4,!0);if(l>=t)continue;let u=0;for(;l<t;){const f=n.getUint8(l);if(f===255)break;l++;const d=f<=u&&u>0?u+f:f;if(u=d,l>=t)break;const h=n.getUint8(l);l++,l++;for(let g=0;g<h&&!(l>=t);g++){const v=d+g;v<r&&(a[v*s+c]=n.getUint8(l)),l++}l++}}return{width:s,height:r,topOffset:o,pixels:a}}function Zd(i,e){const t=Ua(i,"PNAMES");if(!t)return[];const n=t.dv.getInt32(0,!0),s=[];for(let u=0;u<n;u++){let f="";for(let d=0;d<8;d++){const h=t.dv.getUint8(4+u*8+d);if(h===0)break;f+=String.fromCharCode(h)}s.push(f.toUpperCase())}const r=new Map,o=[...pr(i,"P_START","P_END"),...pr(i,"PP_START","PP_END")];for(const u of o)r.has(u.name)||r.set(u.name,{offset:u.offset,size:u.size});for(const u of s)if(!r.has(u)){const f=i.lumps.find(d=>d.name===u&&d.size>0);f&&r.set(u,{offset:f.offset,size:f.size})}const a=new Map;function c(u){if(a.has(u))return a.get(u);const f=r.get(u);if(!f)return a.set(u,null),null;const d=of(i.data,f.offset,f.size);return a.set(u,d),d}const l=[];for(const u of["TEXTURE1","TEXTURE2"]){const f=Ua(i,u);if(!f)continue;const d=f.dv.getInt32(0,!0);for(let h=0;h<d;h++){let v=f.dv.getInt32(4+h*4,!0),p="";for(let A=0;A<8;A++){const S=f.dv.getUint8(v+A);if(S===0)break;p+=String.fromCharCode(S)}p=p.toUpperCase(),v+=8,v+=4;const m=f.dv.getUint16(v,!0);v+=2;const x=f.dv.getUint16(v,!0);v+=2,v+=4;const y=f.dv.getUint16(v,!0);if(v+=2,m===0||x===0||m>4096||x>4096)continue;const M=new Uint8Array(m*x);M.fill(255);for(let A=0;A<y;A++){const S=f.dv.getInt16(v,!0);v+=2;const b=f.dv.getInt16(v,!0);v+=2;const z=f.dv.getUint16(v,!0);if(v+=2,v+=4,z>=s.length)continue;const R=c(s[z]);if(R)for(let F=0;F<R.height;F++){const k=b+F;if(!(k<0||k>=x))for(let O=0;O<R.width;O++){const V=S+O;if(V<0||V>=m)continue;const H=R.pixels[F*R.width+O];H!==255&&(M[k*m+V]=H)}}}const C=new ImageData(m,x),T=C.data;for(let A=0;A<m*x;A++){const S=M[A];S===255?(T[A*4]=0,T[A*4+1]=255,T[A*4+2]=255,T[A*4+3]=255):(T[A*4]=e[S*3],T[A*4+1]=e[S*3+1],T[A*4+2]=e[S*3+2],T[A*4+3]=255)}l.push({name:p,type:"wall",width:m,height:x,dataUrl:Gc(C)})}}return l}const ho=document.createElement("canvas"),Jd=ho.getContext("2d");function Gc(i){return ho.width=i.width,ho.height=i.height,Jd.putImageData(i,0,0),ho.toDataURL()}let Rn=new Map;function Oo(i){const e=i.toUpperCase();return e.length>=5?Rn.get(e+"0")||Rn.get(e+"1")||null:Rn.get(e+"A0")||Rn.get(e+"A1")||null}function Qd(i,e){Rn=new Map;const t=[...pr(i,"S_START","S_END"),...pr(i,"SS_START","SS_END")],n=new Set,s=new Set;for(const r of Object.values(wr)){const o=r.toUpperCase();n.add(o.substring(0,4)),o.length>=5&&s.add(o)}for(const r of t){if(r.size<8||r.name.length<6)continue;const o=r.name.substring(0,4);if(!n.has(o))continue;const a=r.name[4],c=r.name[5];if(c!=="0"&&c!=="1")continue;const l=o+a,u=a==="A",f=s.has(l);if(!u&&!f)continue;const d=l+c;if(Rn.has(l+"0")||c==="1"&&Rn.has(d))continue;const h=of(i.data,r.offset,r.size);if(!h)continue;const g=new ImageData(h.width,h.height),v=g.data;for(let p=0;p<h.width*h.height;p++){const m=h.pixels[p];m===255?v[p*4+3]=0:(v[p*4]=e[m*3],v[p*4+1]=e[m*3+1],v[p*4+2]=e[m*3+2],v[p*4+3]=255)}Rn.set(d,{name:r.name,width:h.width,height:h.height,topOffset:h.topOffset,dataUrl:Gc(g)})}}let ei=new Map;function Wc(){return ei}function Us(i){var e;return((e=ei.get(i.toUpperCase()))==null?void 0:e.dataUrl)??null}function Zi(){return ei.size>0}function eh(i){const e=new Set(i.lumps.map(t=>t.name));for(const t of e){if(/^E\dM\d$/.test(t))return"doom1";if(/^MAP\d\d$/.test(t))return"doom2"}return e.has("SGN2A0")||e.has("VILEA1"),"doom2"}async function th(i){const e=await i.arrayBuffer(),t=Yd(e),n=Kd(t),s=eh(t),r=Tr;if(r!==s){const c={doom1:"DOOM",doom2:"DOOM 2"};if(!confirm(`Map is ${c[r]} but imported WAD is ${c[s]}. Switch to ${c[s]}?`))throw new Error("Import cancelled — game type mismatch")}ef(s);const o=jd(t,n),a=Zd(t,n);Qd(t,n),ei=new Map;for(const c of o)ei.set(c.name,c);for(const c of a)ei.set(c.name,c);return await nh(),await ih(),await It.ref("map/gameType").set(s),{flats:o.length,walls:a.length,gameType:s}}async function nh(){const i={};ei.forEach((e,t)=>{i[t]={name:e.name,type:e.type,width:e.width,height:e.height,dataUrl:e.dataUrl}}),await It.ref("textures").set(i)}async function ih(){const i={};Rn.forEach((e,t)=>{i[t]={name:e.name,width:e.width,height:e.height,topOffset:e.topOffset,dataUrl:e.dataUrl}}),await It.ref("sprites").set(i)}async function sh(){const e=(await It.ref("textures").once("value")).val();if(!e)return;ei=new Map;for(const s of Object.keys(e)){const r=e[s];ei.set(s,{name:r.name,type:r.type,width:r.width,height:r.height,dataUrl:r.dataUrl})}const n=(await It.ref("sprites").once("value")).val();if(n){Rn=new Map;for(const s of Object.keys(n)){const r=n[s];Rn.set(s,{name:r.name,width:r.width,height:r.height,topOffset:r.topOffset,dataUrl:r.dataUrl})}}}const An=new Map,_s=new Map,Ts=new Map;function rh(i){const e=new Set,t=_s.get(i);if(t)for(const n of t){const s=Ts.get(n);s&&e.add(s)}return e}function oh(i,e,t){af(i,e,t);const n=P.linedefs.get(i);n&&cf(i,n.frontSide,n.backSide)}function ah(i,e,t,n,s){var o,a;n&&n!==e&&((o=An.get(n))==null||o.delete(i)),s&&s!==t&&((a=An.get(s))==null||a.delete(i)),af(i,e,t),lf(i);const r=P.linedefs.get(i);r&&cf(i,r.frontSide,r.backSide)}function ch(i,e,t){var n,s;(n=An.get(e))==null||n.delete(i),(s=An.get(t))==null||s.delete(i),lf(i)}function lh(i,e){uf(i,e)}function uh(i,e,t){var n;t&&t!==e&&((n=_s.get(t))==null||n.delete(i)),uf(i,e)}function fh(i,e){var t;e&&((t=_s.get(e))==null||t.delete(i)),Ts.delete(i)}function af(i,e,t){An.has(e)||An.set(e,new Set),An.has(t)||An.set(t,new Set),An.get(e).add(i),An.get(t).add(i)}function cf(i,e,t){e&&Ts.set(e,i),t&&Ts.set(t,i)}function lf(i){for(const[e,t]of Ts)t===i&&Ts.delete(e)}function uf(i,e){e&&(_s.has(e)||_s.set(e,new Set),_s.get(e).add(i))}function mr(i,e,t){let n=null,s=t;return P.vertices.forEach((r,o)=>{const a=Math.hypot(r.x-i,r.y-e);a<s&&(s=a,n=o)}),n}function po(i,e,t){let n=null,s=t;return P.linedefs.forEach((r,o)=>{const a=P.vertices.get(r.v1),c=P.vertices.get(r.v2);if(!a||!c)return;const l=dh(i,e,a.x,a.y,c.x,c.y);l<s&&(s=l,n=o)}),n}function El(i,e,t){let n=null,s=t;return P.things.forEach((r,o)=>{const a=Math.hypot(r.x-i,r.y-e);a<s&&(s=a,n=o)}),n}function dh(i,e,t,n,s,r){const o=s-t,a=r-n,c=o*o+a*a;if(!c)return Math.hypot(i-t,e-n);const l=Math.max(0,Math.min(1,((i-t)*o+(e-n)*a)/c));return Math.hypot(i-(t+l*o),e-(n+l*a))}function ff(i,e,t){let n=!1;for(let s=0,r=t.length-1;s<t.length;r=s++){const o=t[s].x,a=t[s].y,c=t[r].x,l=t[r].y;a>e!=l>e&&i<(c-o)*(e-a)/(l-a)+o&&(n=!n)}return n}function bl(i){let e=0;for(let t=0,n=i.length-1;t<i.length;n=t++)e+=(i[n].x+i[t].x)*(i[n].y-i[t].y);return Math.abs(e)/2}function Fr(i,e,t,n,s,r){return(t-i)*(r-e)-(n-e)*(s-i)}function sr(i,e,t,n,s,r,o,a){if(i===s&&e===r||i===o&&e===a||t===s&&n===r||t===o&&n===a)return!1;const c=Fr(s,r,o,a,i,e),l=Fr(s,r,o,a,t,n),u=Fr(i,e,t,n,s,r),f=Fr(i,e,t,n,o,a);return(c>0&&l<0||c<0&&l>0)&&(u>0&&f<0||u<0&&f>0)}function wo(i){let e=0;for(let t=0,n=i.length-1;t<i.length;n=t++)e+=(i[n].x+i[t].x)*(i[n].y-i[t].y);return e}function Xc(i){const e=rh(i);if(!e.size)return[];const t=new Map;for(const h of e){const g=P.linedefs.get(h);if(!g)continue;const v=P.vertices.get(g.v1),p=P.vertices.get(g.v2);!v||!p||(t.has(g.v1)||t.set(g.v1,[]),t.has(g.v2)||t.set(g.v2,[]),t.get(g.v1).push({angle:Math.atan2(p.y-v.y,p.x-v.x),vid:g.v2}),t.get(g.v2).push({angle:Math.atan2(v.y-p.y,v.x-p.x),vid:g.v1}))}for(const h of t.values())h.sort((g,v)=>g.angle-v.angle);const n=new Map;let s=0;for(const h of t.keys()){if(n.has(h))continue;const g=s++,v=[h];for(;v.length;){const p=v.pop();if(!n.has(p)){n.set(p,g);for(const m of t.get(p))n.has(m.vid)||v.push(m.vid)}}}const r=new Array(s).fill(""),o=new Array(s).fill(-1/0),a=new Array(s).fill(-1/0);for(const[h,g]of n){const v=P.vertices.get(h);(v.x>o[g]||v.x===o[g]&&v.y>a[g])&&(o[g]=v.x,a[g]=v.y,r[g]=h)}const c=new Set;for(let h=0;h<s;h++){const g=r[h],v=t.get(g);c.add(g+"|"+v[0].vid)}const l=new Set,u=[],f=[];for(const[h,g]of t)for(const v of g){const p=h+"|"+v.vid;if(l.has(p))continue;const m=[];let x=!1,y=h,M=v.vid;for(;;){const C=y+"|"+M;c.has(C)&&(x=!0),l.add(C),m.push(y);const T=t.get(M),S=(T.findIndex(b=>b.vid===y)-1+T.length)%T.length;if(y=M,M=T[S].vid,y===h&&M===v.vid||m.length>e.size*2)break}m.length>=3&&(u.push(m),f.push(x))}const d=u.filter((h,g)=>!f[g]);if(d.length>0){const g=d.map(m=>m.map(x=>P.vertices.get(x))).map(m=>wo(m));let v=0,p=0;for(let m=0;m<g.length;m++){const x=Math.abs(g[m]);x>p&&(p=x,v=m)}g[v]<0&&d[v].reverse();for(let m=0;m<d.length;m++)m!==v&&g[m]>0&&d[m].reverse()}return d}function Cr(i){return Xc(i).map(e=>e.map(t=>P.vertices.get(t)).filter(t=>!!t)).filter(e=>e.length>=3)}function hh(i){const e=Cr(i);if(!e.length)return null;let t=e[0],n=bl(t);for(let s=1;s<e.length;s++){const r=bl(e[s]);r>n&&(n=r,t=e[s])}return t}function ti(i,e,t){const n=Cr(t);let s=0;for(const r of n)ff(i,e,r)&&s++;return(s&1)===1}const Si=12,mo=16,Tl=48,gr={player:"#0f0",enemy:"#f44",weapon:"#fa0",ammo:"#f80",health:"#4af",armor:"#4ff",key:"#ff4",powerup:"#f4f",decor:"#888",gore:"#a44"};let On,K;function ph(i){On=i,K=On.getContext("2d")}function df(){if(!On||P.vertices.size===0)return;let i=1/0,e=1/0,t=-1/0,n=-1/0;P.vertices.forEach(u=>{u.x<i&&(i=u.x),u.x>t&&(t=u.x),u.y<e&&(e=u.y),u.y>n&&(n=u.y)});const s=80,r=t-i||1,o=n-e||1,a=(i+t)/2,c=(e+n)/2,l=Math.min((On.width-s*2)/r,(On.height-s*2)/o);Zu(Math.max(.05,Math.min(32,l))),kt.x=On.width/2-a*ft,kt.y=On.height/2+c*ft,St()}function St(){if(!On)return;const i=On.width,e=On.height;K.clearRect(0,0,i,e),K.fillStyle="#0a0a0a",K.fillRect(0,0,i,e),mh(i,e),gh(),vh(),xh(),Sh(),yh(),Mh()}function mh(i,e){const t=xn,n=Fi(0,0),s=Fi(i,e),r=Math.floor(n.x/t)*t,o=Math.ceil(s.x/t)*t,a=Math.floor(s.y/t)*t,c=Math.ceil(n.y/t)*t;if(t*ft>=4){K.strokeStyle="#181818",K.lineWidth=1;for(let u=r;u<=o;u+=t){const f=_t(u,0).x;K.beginPath(),K.moveTo(f,0),K.lineTo(f,e),K.stroke()}for(let u=a;u<=c;u+=t){const f=_t(0,u).y;K.beginPath(),K.moveTo(0,f),K.lineTo(i,f),K.stroke()}}K.strokeStyle="#252525";const l=_t(0,0);K.beginPath(),K.moveTo(l.x,0),K.lineTo(l.x,e),K.stroke(),K.beginPath(),K.moveTo(0,l.y),K.lineTo(i,l.y),K.stroke()}function gh(){P.sectors.forEach((i,e)=>{const t=Cr(e);if(!t.length)return;const n=be&&be.type==="sector"&&be.id===e,s=Pt==="sector"&&et.has(e),r=Rt&&Rt.type==="sector"&&Rt.id===e,o=Math.max(0,Math.min(255,i.light??160)),a=Math.round(20+o/255*70);K.fillStyle=n||s?`rgba(${a+40},${a+30},${Math.round(a*.4)},0.7)`:r?`rgba(${a+20},${a+20},${Math.round(a*.75)+15},0.7)`:`rgba(${a},${a},${Math.round(a*.75)},0.6)`,K.beginPath();for(const c of t){const l=_t(c[0].x,c[0].y);K.moveTo(l.x,l.y);for(let u=1;u<c.length;u++){const f=_t(c[u].x,c[u].y);K.lineTo(f.x,f.y)}K.closePath()}K.fill("evenodd"),n||s?(K.strokeStyle="#ff0",K.lineWidth=2,K.stroke()):r&&(K.strokeStyle="rgba(255, 255, 255, 0.4)",K.lineWidth=1,K.stroke())})}function vh(){P.linedefs.forEach((i,e)=>{const t=P.vertices.get(i.v1),n=P.vertices.get(i.v2);if(!t||!n)return;const s=_t(t.x,t.y),r=_t(n.x,n.y),o=be&&be.type==="linedef"&&be.id===e,a=Pt==="linedef"&&et.has(e),c=Rt&&Rt.type==="linedef"&&Rt.id===e,l=!!(i.flags&4);c&&!o&&!a&&(K.strokeStyle="rgba(255, 255, 255, 0.15)",K.lineWidth=8,K.beginPath(),K.moveTo(s.x,s.y),K.lineTo(r.x,r.y),K.stroke()),K.strokeStyle=o||a?"#ff0":c?"#fff":l?"#aa0":"#ddd",K.lineWidth=o||a||c?2:1,K.beginPath(),K.moveTo(s.x,s.y),K.lineTo(r.x,r.y),K.stroke();const u=(s.x+r.x)/2,f=(s.y+r.y)/2,d=r.x-s.x,h=r.y-s.y,g=Math.hypot(d,h);if(g>0){const v=-h/g,p=d/g;K.strokeStyle="#f00",K.lineWidth=1,K.beginPath(),K.moveTo(u,f),K.lineTo(u+v*6,f+p*6),K.stroke()}})}function xh(){P.vertices.forEach((i,e)=>{const t=_t(i.x,i.y),n=be&&be.type==="vertex"&&be.id===e,s=et.has(e),r=Rt&&Rt.type==="vertex"&&Rt.id===e;r&&!n&&!s&&(K.strokeStyle="rgba(255, 255, 255, 0.3)",K.lineWidth=1,K.beginPath(),K.arc(t.x,t.y,Si,0,Math.PI*2),K.stroke()),K.fillStyle=n||s?"#ff0":r?"#fff":"#0ff";const o=r||n||s?4:3;K.fillRect(t.x-o,t.y-o,o*2,o*2)})}const qo=new Map;function _h(i){if(qo.has(i))return qo.get(i);const e=Oo(i);if(!e)return null;const t=new Image;return t.src=e.dataUrl,t.onload=()=>St(),qo.set(i,t),t}function Sh(){P.things.forEach((i,e)=>{const t=_t(i.x,i.y),n=Ar[i.type]||{cat:"player"},s=Math.max(n.radius*ft,4),r=s*2,o=be&&be.type==="thing"&&be.id===e,a=Rt&&Rt.type==="thing"&&Rt.id===e,c=o?"#ff0":a?"#fff":gr[n.cat]||"#fff";a&&!o&&(K.strokeStyle="rgba(255, 255, 255, 0.2)",K.lineWidth=1,K.beginPath(),K.arc(t.x,t.y,24,0,Math.PI*2),K.stroke());const l=wr[i.type],u=l&&Zi()?_h(l):null;if(u&&u.complete&&u.naturalWidth>0){const f=Math.min(r/u.naturalWidth,r/u.naturalHeight),d=u.naturalWidth*f,h=u.naturalHeight*f;K.imageSmoothingEnabled=!1,K.drawImage(u,t.x-d/2,t.y-h/2,d,h),K.imageSmoothingEnabled=!0}if(Qt==="thing"||o||a){K.strokeStyle=c,K.lineWidth=o||a?2:1,K.strokeRect(t.x-s,t.y-s,r,r);const f=(i.angle??0)*Math.PI/180;K.lineWidth=1,K.beginPath(),K.moveTo(t.x,t.y),K.lineTo(t.x+Math.cos(f)*s,t.y-Math.sin(f)*s),K.stroke()}})}function yh(){if(Qt!=="draw")return;if(Ct.length===0){const l=mr(rt.x,rt.y,Si/ft);if(l){const u=P.vertices.get(l),f=_t(u.x,u.y);K.strokeStyle="#0ff",K.lineWidth=1,K.beginPath(),K.arc(f.x,f.y,Si,0,Math.PI*2),K.stroke()}return}const i=Ct[0],e=Ct[Ct.length-1];let t=zt(rt.x),n=zt(rt.y);const s=mr(rt.x,rt.y,Si/ft);let r=!1;if(s){const l=P.vertices.get(s);t=l.x,n=l.y,r=!0}let o=!1;if(Ct.length>=3&&Math.hypot(t-i.x,n-i.y)<24/ft&&(t=i.x,n=i.y,o=!0),Ct.length>=2){K.fillStyle="rgba(0, 180, 0, 0.08)",K.beginPath();const l=_t(i.x,i.y);K.moveTo(l.x,l.y);for(let f=1;f<Ct.length;f++){const d=_t(Ct[f].x,Ct[f].y);K.lineTo(d.x,d.y)}const u=_t(t,n);K.lineTo(u.x,u.y),K.closePath(),K.fill()}K.strokeStyle="#0f0",K.lineWidth=2;for(let l=0;l<Ct.length-1;l++){const u=_t(Ct[l].x,Ct[l].y),f=_t(Ct[l+1].x,Ct[l+1].y);K.beginPath(),K.moveTo(u.x,u.y),K.lineTo(f.x,f.y),K.stroke()}const a=_t(e.x,e.y),c=_t(t,n);if(K.strokeStyle="#ff0",K.lineWidth=1,K.setLineDash([4,4]),K.beginPath(),K.moveTo(a.x,a.y),K.lineTo(c.x,c.y),K.stroke(),Ct.length>=2){const l=_t(i.x,i.y);K.strokeStyle="rgba(255, 255, 0, 0.3)",K.beginPath(),K.moveTo(c.x,c.y),K.lineTo(l.x,l.y),K.stroke()}K.setLineDash([]);for(let l=0;l<Ct.length;l++){const u=_t(Ct[l].x,Ct[l].y);K.fillStyle=l===0?"#0f0":"#0ff";const f=l===0?5:3;K.fillRect(u.x-f,u.y-f,f*2,f*2)}if(o){const l=_t(i.x,i.y);K.fillStyle="rgba(0, 255, 0, 0.15)",K.beginPath(),K.arc(l.x,l.y,30,0,Math.PI*2),K.fill(),K.strokeStyle="#0f0",K.lineWidth=2,K.beginPath(),K.arc(l.x,l.y,30,0,Math.PI*2),K.stroke()}else r&&(K.strokeStyle="#0ff",K.lineWidth=1,K.beginPath(),K.arc(c.x,c.y,Si,0,Math.PI*2),K.stroke())}function Mh(){if(!Gi)return;const i=_t(Gi.x,Gi.y),e=_t(rt.x,rt.y),t=Math.min(i.x,e.x),n=Math.min(i.y,e.y),s=Math.abs(e.x-i.x),r=Math.abs(e.y-i.y);K.fillStyle="rgba(255, 255, 0, 0.08)",K.fillRect(t,n,s,r),K.strokeStyle="rgba(255, 255, 0, 0.5)",K.lineWidth=1,K.setLineDash([4,4]),K.strokeRect(t,n,s,r),K.setLineDash([])}function hf(i,e,t){for(const[n,s]of i){if(s.v1===e&&s.v2===t)return{ldId:n,sameDirection:!0};if(s.v1===t&&s.v2===e)return{ldId:n,sameDirection:!1}}return null}function Eh(i,e,t,n){const s=new Set,r=new Set;for(const[o,a]of i)o!==n&&(a.v1===e&&s.add(a.v2),a.v2===e&&s.add(a.v1),a.v1===t&&r.add(a.v2),a.v2===t&&r.add(a.v1));for(const o of s)if(o!==t&&r.has(o))return!0;return!1}function bh(i){const e=new Set,t=An.get(i);if(!t)return e;for(const n of t){const s=P.linedefs.get(n);if(s)for(const r of[s.frontSide,s.backSide]){if(!r)continue;const o=P.sidedefs.get(r);o!=null&&o.sector&&e.add(o.sector)}}return e}function Th(i,e){const t=bh(i);for(const n of t)for(const s of Xc(n))if(s.includes(i)&&s.includes(e))return!0;return!1}let Al;function Xe(i){const e=document.getElementById("toast");e.textContent=i,e.classList.add("show"),clearTimeout(Al),Al=setTimeout(()=>e.classList.remove("show"),3e3)}const rr=[],$c=[];let zi=null,or=0,qi=!1,Ss=!1;const Ah=50;function ht(){qi||(or===0&&(zi=[]),or++)}function Ee(i,e,t){qi||!zi||zi.push({path:i,before:e,after:t})}function pt(){qi||or<=0||(or--,or===0&&(zi&&zi.length>0&&(rr.push({changes:zi}),rr.length>Ah&&rr.shift(),$c.length=0),zi=null))}async function wh(){if(Ss)return;const i=rr.pop();if(!i){Xe("Nothing to undo");return}Ss=!0,qi=!0;try{const e={};for(const{path:t,before:n}of i.changes)t in e||(e[t]=n);await It.ref().update(e),$c.push(i)}finally{qi=!1,Ss=!1}}async function Ch(){if(Ss)return;const i=$c.pop();if(!i){Xe("Nothing to redo");return}Ss=!0,qi=!0;try{const e={};for(const{path:t,after:n}of i.changes)e[t]=n;await It.ref().update(e),rr.push(i)}finally{qi=!1,Ss=!1}}let ys=1,qc="",ar="all",Na=null;const pf={player:"Players",enemy:"Enemies",weapon:"Weapons",ammo:"Ammo",health:"Health",armor:"Armor",key:"Keys",powerup:"Power-ups",decor:"Decorations",gore:"Gore"},mf=["player","enemy","weapon","ammo","health","armor","key","powerup","decor","gore"];function Rh(){return ys}function gf(){const i=document.getElementById("thing-type-btn");if(!i)return;const e=Ar[ys],t=wr[ys],n=t?Oo(t):null;let s="";if(n)s+=`<img src="${n.dataUrl}" width="20" height="20" style="image-rendering:pixelated;vertical-align:middle;margin-right:4px;">`;else{const r=gr[e==null?void 0:e.cat]||"#888";s+=`<span style="display:inline-block;width:12px;height:12px;border-radius:50%;background:${r};vertical-align:middle;margin-right:4px;"></span>`}s+=(e==null?void 0:e.name)||`Type ${ys}`,i.innerHTML=s}function Ph(){let i=document.getElementById("thing-browser-modal");if(!i){i=document.createElement("div"),i.id="thing-browser-modal",i.className="tex-modal-overlay",i.style.display="none",i.innerHTML=`
...
`)}function Xh(i){return JSON.stringify(i,null,2)}let yt=[];function Oa(){Wd(yt.map(i=>({x:i.x,y:i.y})))}function Co(){yt=[],Oa()}function js(i,e,t,n){for(const[,s]of P.linedefs){const r=P.vertices.get(s.v1),o=P.vertices.get(s.v2);if(!(!r||!o)&&sr(i,e,t,n,r.x,r.y,o.x,o.y))return!1}for(let s=0;s<yt.length-1;s++){const r=yt[s],o=yt[s+1];if(sr(i,e,t,n,r.x,r.y,o.x,o.y))return!1}return!0}function Yo(i){const e=P.sectors.get(i),t=e?{floor:e.floor,ceiling:e.ceiling,light:e.light,...e.special!=null?{special:e.special}:{},...e.tag!=null?{tag:e.tag}:{},...e.floorTex!=null?{floorTex:e.floorTex}:{},...e.ceilTex!=null?{ceilTex:e.ceilTex}:{}}:{floor:0,ceiling:128,light:160,floorTex:"FLOOR4_8",ceilTex:"CEIL3_5"},n=pe("sectors").push(t);return Ee(`map/sectors/${n.key}`,null,t),n.key}function $h(i){const e=i.map(s=>({loop:s.loop,area2:s.area2,children:[]}));e.sort((s,r)=>Math.abs(r.area2)-Math.abs(s.area2));function t(s,r){if(s.area2<0==r.area2<0)return!1;const o=new Set(s.loop.map(l=>l.ldId));for(const l of r.loop)if(o.has(l.ldId))return s.area2<0&&r.area2>0;const a=P.vertices.get(r.loop[0].fromVid),c=s.loop.map(l=>P.vertices.get(l.fromVid));return ff(a.x,a.y,c)}const n=[];for(let s=0;s<e.length;s++){const r=e[s];let o=null;for(let a=s-1;a>=0;a--)if(t(e[a],r)){o=e[a];break}o?o.children.push(r):n.push(r)}return n}async function Ro(i){const e=yt.length;if(e<2)return;ht();const t=[];for(const r of yt)if(r.existingId)t.push(r.existingId);else{const o={x:r.x,y:r.y},a=pe("vertices").push(o);Ee(`map/vertices/${a.key}`,null,o),t.push(a.key)}const n=i?e:e-1,s=[];for(let r=0;r<n;r++){const o=t[r],a=t[(r+1)%e],c=hf(P.linedefs,o,a);if(c)s.push(c.ldId);else{const l={v1:o,v2:a,flags:1},u=pe("linedefs").push(l);Ee(`map/linedefs/${u.key}`,null,l),s.push(u.key)}}Kh(new Set(s)),pt(),Co()}async function qh(i,e){yt=i,await Ro(e),Co()}async function Yh(i,e){const t=zt(i),n=zt(e),s=mr(i,e,Si/ft);let r,o,a=null;if(s){const f=P.vertices.get(s);r=f.x,o=f.y,a=s}else r=t,o=n;if(Nh(r,o),yt.length===0){yt.push({x:r,y:o,existingId:a}),Oa();return}const c=yt[0],l=yt[yt.length-1];if(r===l.x&&o===l.y)return;const u=24/ft;if(yt.length>=3){const f=Math.hypot(r-c.x,o-c.y)<u,d=a!==null&&a===c.existingId;if(f||d){if(!js(l.x,l.y,c.x,c.y)){Xe("Closing edge would intersect");return}await Ro(!0);return}}if(c.existingId&&yt.length>=1&&a&&!yt.some(f=>f.existingId===a)){if(!js(l.x,l.y,r,o)){Xe("Edge would intersect");return}if(!Th(c.existingId,a)&&!js(r,o,c.x,c.y)){Xe("Closing edge would intersect");return}yt.push({x:r,y:o,existingId:a}),await Ro(!1);return}if(!js(l.x,l.y,r,o)){Xe("Edge would intersect");return}yt.push({x:r,y:o,existingId:a}),Oa()}async function xf(){if(yt.length<3)return!1;const i=yt[0],e=yt[yt.length-1];return js(e.x,e.y,i.x,i.y)?(Fh(),await Ro(!0),!0):(Xe("Closing edge would intersect"),!1)}function Kh(i){const e=new Map;function t(T,A,S){const b=P.vertices.get(T),z=P.vertices.get(A);!b||!z||(e.has(T)||e.set(T,[]),e.get(T).push({angle:Math.atan2(z.y-b.y,z.x-b.x),toVid:A,ldId:S}))}for(const[T,A]of P.linedefs)t(A.v1,A.v2,T),t(A.v2,A.v1,T);for(const T of e.values())T.sort((A,S)=>A.angle-S.angle);function n(T,A,S){const b=e.get(A);let z=-1;for(let F=0;F<b.length;F++)if(b[F].toVid===T&&b[F].ldId===S){z=F;break}if(z===-1)throw new Error("Could not find twin");const R=b[(z+1)%b.length];return{fromVid:A,toVid:R.toVid,ldId:R.ldId}}const s=T=>`${T.ldId}:${T.fromVid}`;function r(T){const A=[];let S=T;for(;A.push(S),S=n(S.fromVid,S.toVid,S.ldId),!(S.fromVid===T.fromVid&&S.toVid===T.toVid&&S.ldId===T.ldId||A.length>P.linedefs.size*2););return A}const o=new Set,a=[];for(const T of i){const A=P.linedefs.get(T);for(const S of[{fromVid:A.v1,toVid:A.v2,ldId:T},{fromVid:A.v2,toVid:A.v1,ldId:T}]){if(o.has(s(S)))continue;const b=r(S);for(const R of b)i.has(R.ldId)&&o.add(s(R));const z=b.map(R=>P.vertices.get(R.fromVid));a.push({loop:b,area2:wo(z)})}}function c(T){const A=P.linedefs.get(T.ldId);return(T.fromVid===A.v1?A.frontSide:A.backSide)??null}function l(T){const A=c(T);if(A)return A;const S=P.linedefs.get(T.ldId),b=T.fromVid===S.v1,z=b?S.backSide:S.frontSide,R=!!z,F={sector:null,xoff:0,yoff:0,upper:R?"STARTAN2":"-",mid:R?"-":"STARTAN2",lower:R?"STARTAN2":"-"},k=pe("sidedefs").push(F);Ee(`map/sidedefs/${k.key}`,null,F);const O={...S},H={[b?"frontSide":"backSide"]:k.key};if(R){H.flags=(O.flags|4)&-2;const U=P.sidedefs.get(z);if(U){const Q={};(!U.upper||U.upper==="-")&&(Q.upper="STARTAN2"),(!U.lower||U.lower==="-")&&(Q.lower="STARTAN2"),U.mid&&U.mid!=="-"&&(Q.mid="-"),Object.keys(Q).length&&(Ee(`map/sidedefs/${z}`,{...U},{...U,...Q}),pe("sidedefs").child(z).update(Q))}}return Ee(`map/linedefs/${T.ldId}`,O,{...O,...H}),pe("linedefs").child(T.ldId).update(H),k.key}function u(T,A){const S=P.sidedefs.get(T);if(S.sector!==A){const b={...S};Ee(`map/sidedefs/${T}`,b,{...S,sector:A}),pe("sidedefs").child(T).update({sector:A})}}const f=new Set,d=[];for(const[T,A]of P.linedefs)for(const S of[{fromVid:A.v1,toVid:A.v2,ldId:T},{fromVid:A.v2,toVid:A.v1,ldId:T}]){if(f.has(s(S)))continue;const b=r(S);for(const R of b)f.add(s(R));const z=b.map(R=>P.vertices.get(R.fromVid));d.push({loop:b,area2:wo(z)})}const h=$h(d);function g(T){return T.map(s).sort().join("|")}const v=new Map,p=new Map;function m(T,A){for(const S of T)v.set(g(S.loop),S),p.set(S,A),m(S.children,S)}m(h,null);const x=new Set,y=new Set(a.map(T=>g(T.loop))),M=[];for(const T of a){const A=T.area2>0;let S=null;for(const F of T.loop){const k=c(F);if(k){const O=P.sidedefs.get(k);if(O!=null&&O.sector){S=O.sector;break}}}let b,z=!1;if(S)x.has(S)?(b=Yo(S),z=!0):b=S;else if(A){let F=null;for(const k of T.loop){const O=P.linedefs.get(k.ldId),H=k.fromVid===O.v1?O.backSide:O.frontSide;if(H){const U=P.sidedefs.get(H);if(U!=null&&U.sector){F=U.sector;break}}}if(F)b=Yo(F);else{const k={floor:0,ceiling:128,light:160,floorTex:"FLOOR4_8",ceilTex:"CEIL3_5"},O=pe("sectors").push(k);Ee(`map/sectors/${O.key}`,null,k),b=O.key}z=!0}else{const F=v.get(g(T.loop));if(!F)continue;const k=p.get(F);if(!k)continue;let O=null;for(const V of k.loop){const H=c(V);if(H){const U=P.sidedefs.get(H);if(U!=null&&U.sector){O=U.sector;break}}}if(!O)continue;x.has(O)?(b=Yo(O),z=!0):b=O}const R=T.loop.map(l);x.add(b);for(const F of R)u(F,b);M.push({face:T,sectorId:b,isNewOrCloned:z})}let C=0;for(;C<M.length;){const{face:T,sectorId:A,isNewOrCloned:S}=M[C++];if(!S)continue;const b=v.get(g(T.loop));if(b)if(T.area2>0)for(const z of b.children){if(y.has(g(z.loop)))continue;const R=z.loop.map(l);for(const F of R)u(F,A)}else{const z=p.get(b);if(z&&!y.has(g(z.loop))){let R=!1;const F=z.loop.map(l);for(const k of F){const O=P.sidedefs.get(k);(!O||O.sector!==A)&&(R=!0),u(k,A)}R&&M.push({face:{loop:z.loop,area2:z.area2},sectorId:A,isNewOrCloned:!0})}}}}function Ba(i,e){const t=Rh(),n={x:i,y:e,angle:0,type:t,flags:7},s=pe("things").push(n);Ee(`map/things/${s.key}`,null,n),Vh(i,e)}function _f(i,e,t){const n=P.linedefs.get(i);if(!n)return;const s=P.vertices.get(n.v1),r=P.vertices.get(n.v2);if(!s||!r||e===s.x&&t===s.y||e===r.x&&t===r.y)return;Hh(i,e,t),ht();const o={x:e,y:t},c=pe("vertices").push(o).key;Ee(`map/vertices/${c}`,null,o);const l=n.v2,u={...n};Ee(`map/linedefs/${i}`,u,{...u,v2:c}),pe("linedefs").child(i).update({v2:c});const f={v1:c,v2:l,flags:u.flags};if(u.special&&(f.special=u.special),u.tag&&(f.tag=u.tag),u.frontSide){const h=P.sidedefs.get(u.frontSide);if(h){const g={...h},v=pe("sidedefs").push(g);Ee(`map/sidedefs/${v.key}`,null,g),f.frontSide=v.key}}if(u.backSide){const h=P.sidedefs.get(u.backSide);if(h){const g={...h},v=pe("sidedefs").push(g);Ee(`map/sidedefs/${v.key}`,null,g),f.backSide=v.key}}const d=pe("linedefs").push(f);Ee(`map/linedefs/${d.key}`,null,f),pt(),Vt({type:"vertex",id:c}),Mi()}function jh(){if(et.size!==2){Xe("Select exactly 2 vertices to merge");return}const[i,e]=[...et],t=P.vertices.get(i),n=P.vertices.get(e);if(!t||!n)return;const s=hf(P.linedefs,i,e);if(!s){Xe("Vertices must be connected by a linedef");return}const r=s.ldId;if(Eh(P.linedefs,i,e,r)){Xe("Merge would create duplicate linedefs");return}kh(i,e),ht();const o=Math.hypot(t.x-rt.x,t.y-rt.y),a=Math.hypot(n.x-rt.x,n.y-rt.y),c=o<a?t:n;c!==n&&(Ee(`map/vertices/${e}`,{...n},{x:c.x,y:c.y}),pe("vertices").child(e).update({x:c.x,y:c.y})),Po(r),P.linedefs.forEach((l,u)=>{const f={};l.v1===i&&(f.v1=e),l.v2===i&&(f.v2=e),Object.keys(f).length&&(Ee(`map/linedefs/${u}`,{...l},{...l,...f}),pe("linedefs").child(u).update(f))}),Ee(`map/vertices/${i}`,{...t},null),pe("vertices").child(i).remove(),pt(),Bt(new Set([e])),Vt({type:"vertex",id:e}),Mi(),Wi()}function Zh(){if(Pt!=="sector"||et.size<2){Xe("Select 2 or more sectors to merge");return}const i=[...et],e=i[i.length-1],t=new Set(i.slice(0,-1));zh(i),ht(),P.sidedefs.forEach((r,o)=>{r.sector&&t.has(r.sector)&&(Ee(`map/sidedefs/${o}`,{...r},{...r,sector:e}),pe("sidedefs").child(o).update({sector:e}))});const n=[];P.linedefs.forEach((r,o)=>{if(!r.frontSide||!r.backSide)return;const a=P.sidedefs.get(r.frontSide),c=P.sidedefs.get(r.backSide);(a==null?void 0:a.sector)===e&&(c==null?void 0:c.sector)===e&&n.push(o)});for(const r of n)Po(r);const s=new Set;P.linedefs.forEach(r=>{s.add(r.v1),s.add(r.v2)}),P.vertices.forEach((r,o)=>{s.has(o)||(Ee(`map/vertices/${o}`,{...r},null),pe("vertices").child(o).remove())});for(const r of t){const o=P.sectors.get(r);o&&(Ee(`map/sectors/${r}`,{...o},null),pe("sectors").child(r).remove())}pt(),Bt(new Set),Vt({type:"sector",id:e}),Mi(),Wi()}function Po(i){const e=P.linedefs.get(i);if(e){if(e.frontSide){const t=P.sidedefs.get(e.frontSide);t&&Ee(`map/sidedefs/${e.frontSide}`,{...t},null),pe("sidedefs").child(e.frontSide).remove()}if(e.backSide){const t=P.sidedefs.get(e.backSide);t&&Ee(`map/sidedefs/${e.backSide}`,{...t},null),pe("sidedefs").child(e.backSide).remove()}Ee(`map/linedefs/${i}`,{...e},null),pe("linedefs").child(i).remove()}}function Sf(){if(!be)return;Oh(be.type,be.id),ht();const{type:i,id:e}=be;if(i==="vertex"){const t=[];P.linedefs.forEach((s,r)=>{(s.v1===e||s.v2===e)&&t.push(r)}),t.forEach(Po);const n=P.vertices.get(e);n&&Ee(`map/vertices/${e}`,{...n},null),pe("vertices").child(e).remove()}else if(i==="linedef")Po(e);else if(i==="sector"){const t=new Set;P.sidedefs.forEach((s,r)=>{s.sector===e&&t.add(r)}),P.linedefs.forEach((s,r)=>{const o=s.frontSide&&t.has(s.frontSide),a=s.backSide&&t.has(s.backSide);if(!o&&!a)return;const c={...s};if(o&&a){const l=P.sidedefs.get(s.frontSide);l&&Ee(`map/sidedefs/${s.frontSide}`,{...l},null),pe("sidedefs").child(s.frontSide).remove();const u=P.sidedefs.get(s.backSide);u&&Ee(`map/sidedefs/${s.backSide}`,{...u},null),pe("sidedefs").child(s.backSide).remove(),Ee(`map/linedefs/${r}`,c,null),pe("linedefs").child(r).remove();for(const f of[s.v1,s.v2]){let d=!1;if(P.linedefs.forEach((h,g)=>{g!==r&&(h.v1===f||h.v2===f)&&(d=!0)}),!d){const h=P.vertices.get(f);h&&Ee(`map/vertices/${f}`,{...h},null),pe("vertices").child(f).remove()}}}else if(o){const l=P.sidedefs.get(s.frontSide);if(l&&Ee(`map/sidedefs/${s.frontSide}`,{...l},null),pe("sidedefs").child(s.frontSide).remove(),s.backSide){const u={frontSide:s.backSide,backSide:null,v1:s.v2,v2:s.v1,flags:(s.flags??1)&-5|1};Ee(`map/linedefs/${r}`,c,{...c,...u}),pe("linedefs").child(r).update(u);const f=P.sidedefs.get(s.backSide);f&&(!f.mid||f.mid==="-")&&(Ee(`map/sidedefs/${s.backSide}`,{...f},{...f,mid:"STARTAN2"}),pe("sidedefs").child(s.backSide).update({mid:"STARTAN2"}))}else Ee(`map/linedefs/${r}`,c,null),pe("linedefs").child(r).remove()}else if(a){const l=P.sidedefs.get(s.backSide);l&&Ee(`map/sidedefs/${s.backSide}`,{...l},null),pe("sidedefs").child(s.backSide).remove();const u={backSide:null,flags:(s.flags??1)&-5|1};Ee(`map/linedefs/${r}`,c,{...c,...u}),pe("linedefs").child(r).update(u);const f=s.frontSide?P.sidedefs.get(s.frontSide):null;f&&(!f.mid||f.mid==="-")&&(Ee(`map/sidedefs/${s.frontSide}`,{...f},{...f,mid:"STARTAN2"}),pe("sidedefs").child(s.frontSide).update({mid:"STARTAN2"}))}});const n=P.sectors.get(e);n&&Ee(`map/sectors/${e}`,{...n},null),pe("sectors").child(e).remove()}else if(i==="thing"){const t=P.things.get(e);t&&Ee(`map/things/${e}`,{...t},null),pe("things").child(e).remove()}pt(),Bh(),Vt(null),Mi()}function Jh(){if(et.size===0)return;Gh(et),ht();const i=new Set(et),e=new Set;P.linedefs.forEach((r,o)=>{(i.has(r.v1)||i.has(r.v2))&&e.add(o)});const t=new Set,n=new Map;P.linedefs.forEach((r,o)=>{if(!e.has(o))for(const a of[r.frontSide,r.backSide]){if(!a)continue;const c=P.sidedefs.get(a);c!=null&&c.sector&&n.set(c.sector,(n.get(c.sector)??0)+1)}});for(const r of e){const o=P.linedefs.get(r);if(o){if(o.frontSide){const a=P.sidedefs.get(o.frontSide);a&&(Ee(`map/sidedefs/${o.frontSide}`,{...a},null),t.add(o.frontSide)),pe("sidedefs").child(o.frontSide).remove()}if(o.backSide){const a=P.sidedefs.get(o.backSide);a&&(Ee(`map/sidedefs/${o.backSide}`,{...a},null),t.add(o.backSide)),pe("sidedefs").child(o.backSide).remove()}Ee(`map/linedefs/${r}`,{...o},null),pe("linedefs").child(r).remove()}}for(const r of i){const o=P.vertices.get(r);o&&Ee(`map/vertices/${r}`,{...o},null),pe("vertices").child(r).remove()}const s=new Set;P.sectors.forEach((r,o)=>{(!n.has(o)||n.get(o)===0)&&s.add(o)});for(const r of s){const o=P.sectors.get(r);o&&Ee(`map/sectors/${r}`,{...o},null),pe("sectors").child(r).remove()}pt(),Bt(new Set),Vt(null),Mi(),Wi()}async function Qh(i,e){const t=P.linedefs.get(i),n=P.linedefs.get(e);if(!t||!n)return;if(i===e){Xe("Select two different linedefs");return}const s=[t.v1,t.v2],r=[n.v1,n.v2];if(new Set([...s,...r]).size!==4){Xe("Cannot bridge: linedefs share a vertex");return}const[o,a]=s.map(v=>P.vertices.get(v)),[c,l]=r.map(v=>P.vertices.get(v));if(!o||!a||!c||!l)return;function u(v,p,m,x){for(const[,y]of P.linedefs){const M=P.vertices.get(y.v1),C=P.vertices.get(y.v2);if(!(!M||!C)&&sr(v,p,m,x,M.x,M.y,C.x,C.y))return!0}return!1}const f=!sr(a.x,a.y,c.x,c.y,l.x,l.y,o.x,o.y)&&!u(a.x,a.y,c.x,c.y)&&!u(l.x,l.y,o.x,o.y),d=!sr(a.x,a.y,l.x,l.y,c.x,c.y,o.x,o.y)&&!u(a.x,a.y,l.x,l.y)&&!u(c.x,c.y,o.x,o.y);let h;if(f)h=[t.v1,t.v2,n.v1,n.v2];else if(d)h=[t.v1,t.v2,n.v2,n.v1];else{Xe("Cannot bridge: connecting edges would intersect");return}const g=h.map(v=>{const p=P.vertices.get(v);return{x:p.x,y:p.y,existingId:v}});await qh(g,!0)}let Lo=null,vr="all",Yc="",yf="";function ep(){let i=document.getElementById("texture-browser-modal");return i||(i=document.createElement("div"),i.id="texture-browser-modal",i.className="tex-modal-overlay",i.style.display="none",i.innerHTML=`
    ...
    <div class="tex-card${s.name===yf.toUpperCase()?" selected":""}" data-name="${s.name}">
      ...
      <input type="checkbox" data-bitmask="${g}" data-bit="${v}" ${m}></div>`}function f(h,g,v=!1){const p=P.sidedefs.get(g);if(!p)return"";const m=x=>`sidedefs/${g}/${x}`;return`<div class="prop-section${v?" active-side":""}">
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ni,depthTest:!1,depthWrite:!1})}function fu(){return new Gn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ko(),fragmentShader:`
		...
		`,blending:ni,depthTest:!1,depthWrite:!1})}function du(){return new Gn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ko(),fragmentShader:`
	...
	`}class od extends Vn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const n={width:e,height:e,depth:1},s=[n,n,n,n,n,n];this.texture=new Xf(s),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},s=new Dr(5,5,5),r=new Gn({name:"CubemapFromEquirect",uniforms:Ds(n.uniforms),vertexShader:n.vertexShader,fragmentShader:n.fragmentShader,side:en,blending:ni});r.uniforms.tEquirect.value=t;const o=new Kt(s,r),a=t.minFilter;return t.minFilter===Vi&&(t.minFilter=qt),new ig(1,10,this).update(e,o),t.minFilter=a,o.geometry.dispose(),o.material.dispose(),this}clear(e,t=!0,n=!0,s=!0){const r=e.getRenderTarget();for(let o=0;o<6;o++)e.setRenderTarget(this,o),e.clear(t,n,s);e.setRenderTarget(r)}}function Jv(i){let e=new WeakMap,t=new WeakMap,n=null;function s(d,h=!1){return d==null?null:h?o(d):r(d)}function r(d){if(d&&d.isTexture){const h=d.mapping;if(h===Ko||h===jo)if(e.has(d)){const g=e.get(d).texture;return a(g,d.mapping)}else{const g=d.image;if(g&&g.height>0){const v=new od(g.height);return v.fromEquirectangularTexture(i,d),e.set(d,v),d.addEventListener("dispose",l),a(v.texture,d.mapping)}else return null}}return d}function o(d){if(d&&d.isTexture){const h=d.mapping,g=h===Ko||h===jo,v=h===Yi||h===ws;if(g||v){let p=t.get(d);const m=p!==void 0?p.texture.pmremVersion:0;if(d.isRenderTargetTexture&&d.pmremVersion!==m)return n===null&&(n=new lu(i)),p=g?n.fromEquirectangular(d,p):n.fromCubemap(d,p),p.texture.pmremVersion=d.pmremVersion,t.set(d,p),p.texture;if(p!==void 0)return p.texture;{const x=d.image;return g&&x&&x.height>0||v&&x&&c(x)?(n===null&&(n=new lu(i)),p=g?n.fromEquirectangular(d):n.fromCubemap(d),p.texture.pmremVersion=d.pmremVersion,t.set(d,p),d.addEventListener("dispose",u),p.texture):null}}}return d}function a(d,h){return h===Ko?d.mapping=Yi:h===jo&&(d.mapping=ws),d}function c(d){let h=0;const g=6;for(let v=0;v<g;v++)d[v]!==void 0&&h++;return h===g}function l(d){const h=d.target;h.removeEventListener("dispose",l);const g=e.get(h);g!==void 0&&(e.delete(h),g.dispose())}function u(d){const h=d.target;h.removeEventListener("dispose",u);const g=t.get(h);g!==void 0&&(t.delete(h),g.dispose())}function f(){e=new WeakMap,t=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:s,dispose:f}}function Qv(i){const e={};function t(n){if(e[n]!==void 0)return e[n];const s=i.getExtension(n);return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const s=t(n);return s===null&&No("WebGLRenderer: "+n+" extension not supported."),s}}}function ex(i,e,t,n){const s={},r=new WeakMap;function o(f){const d=f.target;d.index!==null&&e.remove(d.index);for(const g in d.attributes)e.remove(d.attributes[g]);d.removeEventListener("dispose",o),delete s[d.id];const h=r.get(d);h&&(e.remove(h),r.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function a(f,d){return s[d.id]===!0||(d.addEventListener("dispose",o),s[d.id]=!0,t.memory.geometries++),d}function c(f){const d=f.attributes;for(const h in d)e.update(d[h],i.ARRAY_BUFFER)}function l(f){const d=[],h=f.index,g=f.attributes.position;let v=0;if(g===void 0)return;if(h!==null){const x=h.array;v=h.version;for(let y=0,M=x.length;y<M;y+=3){const C=x[y+0],T=x[y+1],A=x[y+2];d.push(C,T,T,A,A,C)}}else{const x=g.array;v=g.version;for(let y=0,M=x.length/3-1;y<M;y+=3){const C=y+0,T=y+1,A=y+2;d.push(C,T,T,A,A,C)}}const p=new(g.count>=65535?Hf:Vf)(d,1);p.version=v;const m=r.get(f);m&&e.remove(m),r.set(f,p)}function u(f){const d=r.get(f);if(d){const h=f.index;h!==null&&d.version<h.version&&l(f)}else l(f);return r.get(f)}return{get:a,update:c,getWireframeAttribute:u}}function tx(i,e,t){let n;function s(d){n=d}let r,o;function a(d){r=d.type,o=d.bytesPerElement}function c(d,h){i.drawElements(n,h,r,d*o),t.update(h,n,1)}function l(d,h,g){g!==0&&(i.drawElementsInstanced(n,h,r,d*o,g),t.update(h,n,g))}function u(d,h,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,h,0,r,d,0,g);let p=0;for(let m=0;m<g;m++)p+=h[m];t.update(p,n,1)}function f(d,h,g,v){if(g===0)return;const p=e.get("WEBGL_multi_draw");if(p===null)for(let m=0;m<d.length;m++)l(d[m]/o,h[m],v[m]);else{p.multiDrawElementsInstancedWEBGL(n,h,0,r,d,0,v,0,g);let m=0;for(let x=0;x<g;x++)m+=h[x]*v[x];t.update(m,n,1)}}this.setMode=s,this.setIndex=a,this.render=c,this.renderInstances=l,this.renderMultiDraw=u,this.renderMultiDrawInstances=f}function nx(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,o,a){switch(t.calls++,o){case i.TRIANGLES:t.triangles+=a*(r/3);break;case i.LINES:t.lines+=a*(r/2);break;case i.LINE_STRIP:t.lines+=a*(r-1);break;case i.LINE_LOOP:t.lines+=a*r;break;case i.POINTS:t.points+=a*r;break;default:Ze("WebGLInfo: Unknown draw mode:",o);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function ix(i,e,t){const n=new WeakMap,s=new Tt;function r(o,a,c){const l=o.morphTargetInfluences,u=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,f=u!==void 0?u.length:0;let d=n.get(a);if(d===void 0||d.count!==f){let z=function(){S.dispose(),n.delete(a),a.removeEventListener("dispose",z)};var h=z;d!==void 0&&d.texture.dispose();const g=a.morphAttributes.position!==void 0,v=a.morphAttributes.normal!==void 0,p=a.morphAttributes.color!==void 0,m=a.morphAttributes.position||[],x=a.morphAttributes.normal||[],y=a.morphAttributes.color||[];let M=0;g===!0&&(M=1),v===!0&&(M=2),p===!0&&(M=3);let C=a.attributes.position.count*M,T=1;C>e.maxTextureSize&&(T=Math.ceil(C/e.maxTextureSize),C=e.maxTextureSize);const A=new Float32Array(C*T*4*f),S=new kf(A,C,T,f);S.type=Bn,S.needsUpdate=!0;const b=M*4;for(let R=0;R<f;R++){const F=m[R],k=x[R],O=y[R],V=C*T*4*R;for(let H=0;H<F.count;H++){const U=H*b;g===!0&&(s.fromBufferAttribute(F,H),A[V+U+0]=s.x,A[V+U+1]=s.y,A[V+U+2]=s.z,A[V+U+3]=0),v===!0&&(s.fromBufferAttribute(k,H),A[V+U+4]=s.x,A[V+U+5]=s.y,A[V+U+6]=s.z,A[V+U+7]=0),p===!0&&(s.fromBufferAttribute(O,H),A[V+U+8]=s.x,A[V+U+9]=s.y,A[V+U+10]=s.z,A[V+U+11]=O.itemSize===4?s.w:1)}}d={count:f,texture:S,size:new Pe(C,T)},n.set(a,d),a.addEventListener("dispose",z)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)c.getUniforms().setValue(i,"morphTexture",o.morphTexture,t);else{let g=0;for(let p=0;p<l.length;p++)g+=l[p];const v=a.morphTargetsRelative?1:1-g;c.getUniforms().setValue(i,"morphTargetBaseInfluence",v),c.getUniforms().setValue(i,"morphTargetInfluences",l)}c.getUniforms().setValue(i,"morphTargetsTexture",d.texture,t),c.getUniforms().setValue(i,"morphTargetsTextureSize",d.size)}return{update:r}}function sx(i,e,t,n,s){let r=new WeakMap;function o(l){const u=s.render.frame,f=l.geometry,d=e.get(l,f);if(r.get(d)!==u&&(e.update(d),r.set(d,u)),l.isInstancedMesh&&(l.hasEventListener("dispose",c)===!1&&l.addEventListener("dispose",c),r.get(l)!==u&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),r.set(l,u))),l.isSkinnedMesh){const h=l.skeleton;r.get(h)!==u&&(h.update(),r.set(h,u))}return d}function a(){r=new WeakMap}function c(l){const u=l.target;u.removeEventListener("dispose",c),n.releaseStatesOfObject(u),t.remove(u.instanceMatrix),u.instanceColor!==null&&t.remove(u.instanceColor)}return{update:o,dispose:a}}const rx={[Ef]:"LINEAR_TONE_MAPPING",[bf]:"REINHARD_TONE_MAPPING",[Tf]:"CINEON_TONE_MAPPING",[Af]:"ACES_FILMIC_TONE_MAPPING",[Cf]:"AGX_TONE_MAPPING",[Rf]:"NEUTRAL_TONE_MAPPING",[wf]:"CUSTOM_TONE_MAPPING"};function ox(i,e,t,n,s){const r=new Vn(e,t,{type:i,depthBuffer:n,stencilBuffer:s}),o=new Vn(e,t,{type:si,depthBuffer:!1,stencilBuffer:!1}),a=new Sn;a.setAttribute("position",new vn([-1,3,0,-1,-1,0,3,-1,0],3)),a.setAttribute("uv",new vn([0,2,0,0,2,0],2));const c=new Jm({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
`)}const n_={[Ef]:"Linear",[bf]:"Reinhard",[Tf]:"Cineon",[Af]:"ACESFilmic",[Cf]:"AgX",[Rf]:"Neutral",[wf]:"Custom"};function i_(i,e){const t=n_[e];return t===void 0?(Fe("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const co=new B;function s_(){Je.getLuminanceCoefficients(co);const i=co.x.toFixed(4),e=co.y.toFixed(4),t=co.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}const h_={[xo]:"SHADOWMAP_TYPE_PCF",[Zs]:"SHADOWMAP_TYPE_VSM"};function p_(i){return h_[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const m_={[Yi]:"ENVMAP_TYPE_CUBE",[ws]:"ENVMAP_TYPE_CUBE",[Bo]:"ENVMAP_TYPE_CUBE_UV"};function g_(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":m_[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const v_={[ws]:"ENVMAP_MODE_REFRACTION"};function x_(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":v_[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const __={[Mf]:"ENVMAP_BLENDING_MULTIPLY",[Rp]:"ENVMAP_BLENDING_MIX",[Pp]:"ENVMAP_BLENDING_ADD"};function S_(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":__[i.combine]||"ENVMAP_BLENDING_NONE"}function y_(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function M_(i,e,t,n){const s=i.getContext(),r=t.defines;let o=t.vertexShader,a=t.fragmentShader;const c=p_(t),l=g_(t),u=x_(t),f=S_(t),d=y_(t),h=r_(t),g=o_(r),v=s.createProgram();let p,m,x=t.glslVersion?"#version "+t.glslVersion+`
